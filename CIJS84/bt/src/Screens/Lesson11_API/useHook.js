...
import axiosCommentApi from '../../api/Axios/CommentApi';

//console.log(axiosCommentApi.GetComment());

const getDataCommentByAxios = async () => {
  const response = await axiosCommentApi.GetComment();
...
getDataCommentByAxios();

// const listComments = getDataCommentByAxios();
